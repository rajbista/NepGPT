...
/**
 * Records CokeGPT messageId to all response messages' metadata
 *
 * @param {Object} params - The parameters for initializing a thread.
 * @param {OpenAIClient} params.openai - The OpenAI client instance.
 * @param {string} params.thread_id - Response thread ID.
 * @param {string} params.messageId - The response `messageId` generated by CokeGPT.
...
/**
 * Synchronizes CokeGPT messages to Thread Messages.
 * Updates the CokeGPT DB with any missing Thread Messages and
 ...
 * @param {TMessage[]} params.dbMessages - The CokeGPT DB messages.
 ...
 * @param {OpenAIClient} params.openai - The OpenAI client instance.
 * @param {string} params.endpoint - The current endpoint.
 * @param {string} [params.latestMessageId] - Optional: The latest message ID from CokeGPT.
 * @param {string} params.thread_id - Response thread ID.
 * @param {string} params.run_id - Response Run ID.
 * @param {string} params.conversationId - CokeGPT conversation ID.
 * @return {Promise<TMessage[]>} A promise that resolves to the updated messages
 */
 ...
 * @param {OpenAIClient} params.openai - The OpenAI client instance.
 * @param {RunClient} params.client - The CokeGPT client that manages the run: either refers to `OpenAI` or `StreamRunManager`.
